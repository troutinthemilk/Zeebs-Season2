...
plot(D.vec, cv.dist.est, log="xy", lwd=2, type='l', xlab="Density", ylab="Coefficient of variation", main=expression(paste("Lake Florida (", alpha, "=3.92)")), col='white', ylim=c(0.1,10))
...
lines(D.vec, cv.dist.opt, lwd=2, col="brown", lty=2)
...
cv.vec <- c(cv.dist.est, cv.dub.est, cv.quad.est)
plot(D.vec, cv.dist.est, log="xy", lwd=2, type='l', xlab="Density", ylab="Coefficient of variation", ylim=c(0.01,10), main=expression(paste("Lake Burgen (", alpha, "=0.30)")), col="white")
...
cv.vec <- c(cv.dist.est, cv.dub.est, cv.quad.est)
plot(D.vec, cv.dist.est, log="xy", lwd=2, type='l', xlab="Density", ylab="Coefficient of variation", , ylim=c(0.01, 10), main=expression(paste("Little Birch Lake (", alpha, "=0.90)")), col='white')
