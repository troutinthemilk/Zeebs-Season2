...
The average probability of detecting a mussel by one of the observers is $\hat{P}=0.58$ with a standard error of $0.06$.  Below, we overlay the estimated detection model on the histogram of detection distances made by the two observers. 
```{r, warning=F}
