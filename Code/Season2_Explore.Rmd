...
index             <- 1
dist.type <- "hr"
LB.distance.est   <- distance.dens.est(curr.lake[index], curr.lake2[index], var.type=var.type, dist.type="hr")
...
We found that habitat time did not vary depending on survey type, therefore we pooled those values together. The $R^2$ values for these regressions were around 40\%, though the encounter time was more like 30\%. It's also worth noting tha9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999t time to conduct the survey varies with detections, but this was not modeled as the number of detections varies the type of survey. Below we look at some plots of the time to conduct a transect on Lake Burgan:
```{r, echo=F, warning=F}
