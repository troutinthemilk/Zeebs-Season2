...
#quadrat.dat %>% group_by('Lake name', "Transect #", "Observer name", "Distance along transect (m)") %>% dplyr::select(.$'Lake name' = "Lake Florida") %>% print(n=dim(quadrat.dat)[1]) %>% print(width=Inf) #%>% count() %>% filter(n>1) %>% print()
#distance.dat %>% group_by('Lake name', "Transect #", "Observer name", "Distance along transect (m)") %>% print(n=dim(distance.dat)[1]) #%>% print(width=Inf) #%>% count() %>% filter(n>1) %>% print()
...
LBL.distance.est.jack   <- distance.dens.est(curr.lake[index], curr.lake2[index], var.type="jack")
LBL.double.est.jack     <- double.dens.est(curr.lake[index], curr.lake2[index], var.type="jack")
LBL.quadrat.est.jack    <- quadrat.dens.est(curr.lake[index], curr.lake2[index], var.type="jack")
LBL.distance.est.design   <- distance.dens.est(curr.lake[index], curr.lake2[index], var.type="design")
LBL.double.est.design     <- double.dens.est(curr.lake[index], curr.lake2[index], var.type="design")
LBL.quadrat.est.design    <- quadrat.dens.est(curr.lake[index], curr.lake2[index], var.type="design")
LBL.distance.est.model    <- distance.dens.est(curr.lake[index], curr.lake2[index], var.type="model")
LBL.double.est.model      <- double.dens.est(curr.lake[index], curr.lake2[index], var.type="model")
...
LF.distance.est.jack   <- distance.dens.est(curr.lake[index], curr.lake2[index], var.type="jack")
...
LF.distance.est.design   <- distance.dens.est(curr.lake[index], curr.lake2[index], var.type="design")
...
LF.distance.est.model    <- distance.dens.est(curr.lake[index], curr.lake2[index], var.type="model")
...
```{r varianceEst, echo=F, fig.asp=0.3, warning=F, fig.cap="Variance estimators applied on each survey design type."}
